            ...
            <div class="row">
                <div class="col-lg-7 mb-5">
                    <div class="contact-form">
                        ...
                        <form action='contact_action.php' class="form" method="post" >
                            ...
                            <div class="control-group">
                                <input type="number" class="form-control" id="mobile number" name='mobile' placeholder="Your  mobile number" required="required" data-validation-required-message="Please enter your mobile number" />
                                <p class="help-block text-danger"></p>
                            </div>
                            <div class="control-group">
                ...
                <div class="col-lg-5 mb-5">
                    <p>"Have a question or need more information? Reach out to us, and we'll be happy to assist with any inquiries. Contact us today, and let’s clear up any queries you may have!"</p>
                    <div class="d-flex">
                    ...
                    <div class="d-flex">
                        ...
                        <div class="pl-3">
                            <h5>Email</h5>
                            <p>soumenmaity721427@gmail.com</p>
                        </div>
                    </div>
                    <div class="d-flex">
                    ...
                    <div class="d-flex">
                        ...
                        <div class="pl-3">
                            <h5>Opening Hours for any quarry </h5>
